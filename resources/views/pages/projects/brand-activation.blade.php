...
@section('title', 'Project Brand Activation | Sacoret')
            ...
            <div class="row gy-5">
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="service-box">
                        ...
                        <div class="services-list">
                            ...
                            <a href="{{ url('/projects/brand-activation') }}" class="active"><i
                ...
                <div class="col-lg-8 ps-lg-5" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p>
                        ...
                        kesadaran dan loyalitas merek. Dengan pendekatan yang kreatif dan strategis, kami membantu Anda
                        menciptakan momen yang berkesan dan meningkatkan interaksi dengan audiens.
                    </p>
                    <p>
                        Percayakan Brand Activation kepada kami untuk menghidupkan merek Anda dan menciptakan dampak yang
                        positif di pasar.
                    </p>
                    <p>
                        <b>Benefit Brand Activation :</b>
                    </p>
                    <ul>
                        <li>
                            <i class="bi bi-check-circle"></i>
                            Menciptakan Keterlibatan Emosional: Pengalaman yang menarik dapat membangun hubungan yang kuat
                            dengan konsumen.
                        </li>
                        <li>
                            <i class="bi bi-check-circle"></i>
                            Meningkatkan Kesadaran Merek: Aktivasi merek yang efektif dapat meningkatkan visibilitas merek
                            Anda.
                        </li>
                        <li>
                            <i class="bi bi-check-circle"></i>
                            Mendorong Interaksi: Menciptakan kesempatan bagi konsumen untuk berinteraksi langsung dengan
                            merek Anda.
                        </li>
                        <li>
                            <i class="bi bi-check-circle"></i>
                            Meningkatkan Loyalitas Pelanggan: Pengalaman positif dapat meningkatkan loyalitas dan retensi
                            pelanggan.
                        </li>
                    </ul>
                </div>
